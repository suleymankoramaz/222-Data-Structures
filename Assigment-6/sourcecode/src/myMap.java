...
public class myMap
{
    ...
    /**
     * This Java function prints out the contents of a map, including the key, count, and associated
     * words.
     */
    protected void printMap()
    {
        for(String key : getMap().keySet()) 
        {
            ...
            System.out.print("Letter: " + key + " - Count: " + info.getCount());
            System.out.print(" - Words: [" + String.join(", ", info.getWords()) + "]\n");
        }
    }
