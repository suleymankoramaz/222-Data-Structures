// Declaring a package called LinkedList.
package LList;
...
public class Account{
    ...
    /** The LinkedList for posts of the account*/ 
    private LinkedList<Post>    posts;
    /** The LinkedList for inbox of the account*/ 
    private LinkedList<Message> inbox;
    /** The LinkedList for outbox of the account*/ 
    private LinkedList<Message> outbox;
    /** The LinkedList for following of the account*/ 
    private LinkedList<Account> following;
    /** The LinkedList for followers of the account*/ 
    private LinkedList<Account> followers;
    /** The LinkedList for blocked accounts of the account*/ 
    private LinkedList<Account> blockedAccounts;
    /** The LinkedList for history */
    ...
    /**
     * This function returns an LinkedList of Post objects.
     * 
    ...
    /**
     * This function returns the inbox LinkedList.
     * 
     * @return The inbox LinkedList.
     */
    public LinkedList<Message> getInbox(){
        return inbox;
    }
    /**
     * This function returns the outbox LinkedList.
     * 
     * @return The outbox LinkedList.
     */
    public LinkedList<Message> getOutbox(){
        return outbox;
    }
    /**
     * This function returns the following LinkedList.
     * 
    ...
    /**
     * This function returns an LinkedList of accounts that are following the account that called this
     * function.
     * 
     * @return An LinkedList of Account objects.
     */
    ...
    /**
     * This function returns an LinkedList of blocked accounts.
     * 
     * @return An LinkedList of blocked accounts.
     */
    public LinkedList<Account> getBlockedAccounts(){
        return blockedAccounts;
    }
    /**
     * This function returns an LinkedList of history strings.
     * 
     * @return An LinkedList of strings of history.
     */
    ...
    public void setPosts(Post post, int process){
        if(process == 0){//add
            if(posts.add(post) == false)
                System.out.println("An error occured when adding post to the LinkedList.");
        }
        else if(process == 1){//remove
            if(posts.remove(post) == false)
                System.out.println("This post in not in the LinkedList.");
        }
    }
    /**
    ...
    public void viewProfile(Account account){
        if(getIsLogin()){
            if(!isBlocked(account)){
                LinkedList<Account> following = account.getFollowing();
    ...
    public void viewPosts(Account account){
        if(getCurrentAccount() == account.getAccountID()){
            LinkedList<Post> userPosts = account.getPosts();
            if(userPosts.size() > 0){
    ...
    public void viewInteractions(Account account, LinkedList<Account> accounts){
        if((getCurrentAccount() == account.getAccountID()) && getIsPostAreShown()){
            ...
            for(int i=0; i<userPosts.size(); i++){
                ...
                LinkedList<Like>    likes = userPosts.get(i).getLikes();
                LinkedList<Comment> comments = userPosts.get(i).getComments();
    ...
    public void like(int postID, Account account){
        if(isPostsAreShown){
            LinkedList<Post> tempPosts = account.getPosts();
    ...
    public void checkInbox(){
        if(isLogin){
            LinkedList<Message> temporary = getInbox();
            if(temporary.size() > 0){
                System.out.println("----------------------------");
    ...
    public void checkOutbox(){
        if(isLogin){
            LinkedList<Message> temporary = getOutbox();
            if(temporary.size() > 0){
                System.out.println("----------------------------");
                for(int i=0; i<temporary.size(); i++){
                    System.out.printf("Message ID: %d\n",temporary.get(i).getMessageID());
    ...
    public boolean checkIsFollowing(Account account){
        LinkedList<Account> temp = getFollowing();
    ...
    public boolean checkIsFollower(Account account){
        LinkedList<Account> temp = getFollowers();
        for(int i=0; i<temp.size(); i++){
            if(temp.get(i).getAccountID() == account.getAccountID())
                return true;
        }
    ...
    public boolean isBlocked(Account account){
        LinkedList<Account> blockedAccounts = account.getBlockedAccounts();
     ...
     * @return A boolean value.
     */
    public boolean checkAnyLogin(LinkedList<Account> accounts){
     ...
     * user account that is performing the "unlike" action.
     */
    public void unlike(int postID, Account account){
        if(isPostsAreShown){
            ...
            for(int i=0; i<tempPosts.size(); i++){
                if(tempPosts.get(i).getPostID() == postID){
                    LinkedList<Like> tempLikes = tempPosts.get(i).getLikes();
    ...
    /**
     * The function allows an account to remove their own comment from a post.
     * 
     ...
     * @param interactionID The interaction ID is a unique identifier for a specific interaction (such
     * as a comment or like) on a post. It is used to identify which interaction is being referred to
     * in the uncomment method.
     */
    public void uncomment(int postID, Account account,int interactionID){
        if(isPostsAreShown){
            ...
            for(int i=0; i<tempPosts.size(); i++){
                if(tempPosts.get(i).getPostID() == postID){
                    LinkedList<Comment> tempComments = tempPosts.get(i).getComments();
    ...
    public void showHistory(){
        if(isLogin){
            LinkedList<String> tempHistory = this.getHistory();
